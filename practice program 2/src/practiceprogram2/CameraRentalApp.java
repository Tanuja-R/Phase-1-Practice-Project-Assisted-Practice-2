...
class CameraRentalApp { 
	...
	public CameraRentalApp() { 
		...
		cameraList.add(new Camera(1, "Samsung", "DS123", 500.0, true)); 
		cameraList.add(new Camera(2, "Sony", "HD214", 500.0, true)); 
		cameraList.add(new Camera(3, "Panasonic", "XC", 500.0, true)); 
		cameraList.add(new Camera(4, "Canon", "XLR", 500.0, false)); 
		cameraList.add(new Camera(5, "Fujitsu", "J5", 500.0, true)); 
		cameraList.add(new Camera(6, "Sony", "HD226", 500.0, true)); 
		cameraList.add(new Camera(7, "Samsung", "DS246", 500.0, true)); 
		cameraList.add(new Camera(8, "LG", "L123", 500.0, true)); 
		cameraList.add(new Camera(9, "Canon", "XPL", 500.0, true)); 
		cameraList.add(new Camera(10, "Chroma", "CT", 500.0, true)); 
		cameraList.add(new Camera(11, "Something", "some", 200.0, false)); 
		cameraList.add(new Camera(12, "Some", "Another", 100.0, true)); 
		cameraList.add(new Camera(13, "Canon", "Digital", 123.0, false)); 
		cameraList.add(new Camera(14, "Nikon", "DSLR-D7500", 500.0, true)); 
		cameraList.add(new Camera(15, "Sony", "DSLR12", 200.0, true)); 
		cameraList.add(new Camera(17, "Samsung", "SM123", 200.0, true)); 
		cameraList.add(new Camera(19, "SONY", "SONY1234", 123.0, true)); 
	} 
	...
	public void login() { 
    	...
    	System.out.println("+----------------------------------------+");
    	System.out.println("Developer name: Tanuja R\nDeveloper contact number: 9663171848");
    	System.out.println("+----------------------------------------+");
		...
		if (username.equals("admin") && password.equals("admin@123")) { 
			...
			System.out.println("Invalid credentials. Exiting the app..."); 
		} 
	} 
	...
	public void viewAllCameras() { 
		...
		Collections.sort(cameraList, Comparator.comparingInt(Camera::getId)); 
		System.out.println("\nAVAILABLE CAMERAS:"); 
		displayCameraList(); 
		showMainMenu(); 
		System.out.println("\nALL CAMERAS"); 
